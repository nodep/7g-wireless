...
#define  USB_CFG_VENDOR_ID       0x72, 0xa1		// just a random number
 ...
 */
#define USB_CFG_VENDOR_NAME     'f','e','r','e','n','c','.','s','z','i','l','i','@',\
										'g','m','a','i','l','.','c','o','m'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     '7','G',' ','W','i','r','e','l','e','s','s', \
										' ','K','e','y','b','o','a','r','d'
 ...
 */
#define USB_CFG_SERIAL_NUMBER   'v','0','.','0','2'
...
#define USB_CFG_DESCR_PROPS_HID                     0	// included in the configuration descriptor
